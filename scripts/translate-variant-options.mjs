...
const VALUES = {
  ...
  navy: loc("Marinblå", "Marineblå", "Marineblå", "Laivastonsininen"),
  "coffee color": loc("Kaffe", "Kaffe", "Kaffe", "Kahvi"),
  "deep army": loc("Mörk armégrön", "Mørk armygrønn", "Mørk armygrøn", "Tumma armeijanvihreä"),
  "light military": loc("Ljus militärgrön", "Lys armygrønn", "Lys armygrøn", "Vaalea armeijanvihreä"),
  "red coffee": loc("Rödbrun", "Rødbrun", "Rødbrun", "Punaruskea"),
  "dream blue": loc("Drömblå", "Drømmeblå", "Drømmeblå", "Unelmansininen"),
  "greyish red": loc("Gråröd", "Grårød", "Grårød", "Harmaanpunainen"),
  "black and white": loc("Svart och vit", "Svart og hvit", "Sort og hvid", "Musta ja valkoinen"),
  "orange red": loc("Orangeröd", "Oransjerød", "Orangerød", "Oranssinpunainen"),
  "flat thin": loc("Smal modell", "Smal modell", "Smal model", "Kapea malli"),
  "m8513 camel": loc("Kamel", "Kamel", "Kamel", "Kameli"),
  "m8513 orange": loc("Orange", "Oransje", "Orange", "Oranssi"),
  "m8513 green": loc("Grön", "Grønn", "Grøn", "Vihreä"),
  "m8513 medium gray": loc("Mellangrå", "Mellomgrå", "Mellemgrå", "Keskiharmaa"),
  "m8513 black": loc("Svart", "Svart", "Sort", "Musta"),
  "1950 fleece lined black": loc(
    "Svart, fleecefoder",
    "Svart, fleecefôr",
    "Sort, fleecefor",
    "Musta, fleecevuoori",
  ),
  "1950 plus velvet gray": loc(
    "Grå, sammet",
    "Grå, fløyel",
    "Grå, fløjl",
    "Harmaa, sametti",
  ),
  "gray with navy blue": loc(
    "Grå med marinblått",
    "Grå med marineblått",
    "Grå med marineblåt",
    "Harmaa ja laivastonsininen",
  ),
  "navy blue with white": loc(
    "Marinblå med vitt",
    "Marineblå med hvitt",
    "Marineblå med hvidt",
    "Laivastonsininen ja valkoinen",
  ),
  "light blue with white": loc(
    "Ljusblå med vitt",
    "Lyseblå med hvitt",
    "Lyseblå med hvidt",
    "Vaaleansininen ja valkoinen",
  ),
  "khaki with white": loc(
    "Khaki med vitt",
    "Khaki med hvitt",
    "Khaki med hvidt",
    "Khaki ja valkoinen",
  ...
  "black with white": loc(
    "Svart med vitt",
    "Svart med hvitt",
    "Sort med hvidt",
    "Musta ja valkoinen",
  ),
  "black with symbol": loc(
    "Svart, med märke",
    "Svart, med merke",
    "Sort, med mærke",
    "Musta, merkillä",
  ),
  "black without standard": loc(
    "Svart, utan märke",
    "Svart, uten merke",
    "Sort, uden mærke",
    "Musta, ilman merkkiä",
  ),
  "wine red with label": loc(
    "Vinröd, med etikett",
    "Vinrød, med etikett",
    "Vinrød, med etiket",
    "Viininpunainen, etiketillä",
  ),
  "wine red without label": loc(
    "Vinröd, utan etikett",
    "Vinrød, uten etikett",
    "Vinrød, uden etiket",
    "Viininpunainen, ilman etikettiä",
  ),
  "coffee with label": loc(
    "Kaffe, med etikett",
    "Kaffe, med etikett",
    "Kaffe, med etiket",
    "Kahvi, etiketillä",
  ),
  "coffee without label": loc(
    "Kaffe, utan etikett",
    "Kaffe, uten etikett",
    "Kaffe, uden etiket",
    "Kahvi, ilman etikettiä",
  ),
  "dark gray with label": loc(
    "Mörkgrå, med etikett",
    "Mørkegrå, med etikett",
    "Mørkegrå, med etiket",
    "Tummanharmaa, etiketillä",
  ),
  "dark gray without standard": loc(
    "Mörkgrå, utan etikett",
    "Mørkegrå, uten etikett",
    "Mørkegrå, uden etiket",
    "Tummanharmaa, ilman etikettiä",
  ),
  "navy blue with label": loc(
    "Marinblå, med etikett",
    "Marineblå, med etikett",
    "Marineblå, med etiket",
    "Laivastonsininen, etiketillä",
  ),
  "navy blue without label": loc(
    "Marinblå, utan etikett",
    "Marineblå, uten etikett",
    "Marineblå, uden etiket",
    "Laivastonsininen, ilman etikettiä",
  ),
  one: loc("En storlek", "Én størrelse", "Én størrelse", "Yksi koko"),
  xs: loc("XS", "XS", "XS", "XS"),
  "2xl": loc("XXL", "XXL", "XXL", "XXL"),
  "3xl": loc("XXXL", "XXXL", "XXXL", "XXXL"),
  "54 2xl": loc("54 XXL", "54 XXL", "54 XXL", "54 XXL"),
  "56 3xl": loc("56 XXXL", "56 XXXL", "56 XXXL", "56 XXXL"),
  "165": loc("165 cm", "165 cm", "165 cm", "165 cm"),
  "170": loc("170 cm", "170 cm", "170 cm", "170 cm"),
  "175": loc("175 cm", "175 cm", "175 cm", "175 cm"),
  "180": loc("180 cm", "180 cm", "180 cm", "180 cm"),
  "185": loc("185 cm", "185 cm", "185 cm", "185 cm"),
